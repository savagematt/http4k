...
import org.http4k.openapi.OpenApiApiKeySecurity
import org.http4k.openapi.OpenApiHttpSecurity
import org.http4k.openapi.OpenApiOAuth2Security
import org.http4k.openapi.OpenApiOpenIdConnectSecurity
...
class OpenApiSecuritySchemeDsl(original: OpenApiSecurityScheme)
    ...
    class ApiKey(original: OpenApiApiKeySecurity)
        : BaseBuilder<OpenApiApiKeySecurity, ApiKey>(OpenApiSecuritySchemeDsl::ApiKey) {
    ...
    class Http(original: OpenApiHttpSecurity)
        : BaseBuilder<OpenApiHttpSecurity, Http>(OpenApiSecuritySchemeDsl::Http) {
    ...
    class OAuth2(original: OpenApiOAuth2Security)
        : BaseBuilder<OpenApiOAuth2Security, OAuth2>(OpenApiSecuritySchemeDsl::OAuth2) {
    ...
    class OpenIdConnect(original: OpenApiOpenIdConnectSecurity)
        : BaseBuilder<OpenApiOpenIdConnectSecurity, OpenIdConnect>(OpenApiSecuritySchemeDsl::OpenIdConnect) {
